...
<div class="row">
<div class="col-lg-12">
<h3 class="page-header">微信批量对话生成器</h3>
<hr>
</div>
</div>
...
<p>
<span>批量数量：</span>
<input type="text" value="" class="input" id='batchnum'>
<a class="" href="javascript:;">批量生成的数量</a>
</p>
...
<div id="iphone" class="iphone iphone-preview" data-img='0'>
<div class="i-top">
